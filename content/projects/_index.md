...
{{< boxes-container >}}
    ...
    {{< box image="/images/opz3.png" alt="an orange pi zero 3" title="Auto" summary="A Python tool that automates the configuration of a target micro-sd card and creates a bootable Linux Image on it. " link="https://github.com/wil-scott/opz3_autoconfig_tool" >}}
